...
const url =
  "https://www.flipkart.com/clothing-and-accessories/topwear/~cs-xy1011hvj1/pr?sid=clo%2Cash&otracker=categorytree&p%5B%5D=facets.brand%255B%255D%3DNike&p%5B%5D=facets.brand%255B%255D%3DPuma&p%5B%5D=facets.brand%255B%255D%3DREEBOK&p%5B%5D=facets.brand%255B%255D%3DADIDAS&page=2";
...
let getData = (html) => {
  ...
  $("._2B_pmu").each((index, element) => {
    ...
    TBrand[index] = { iD, Category: "Tees", Brand, Gender: "F" };
  });
  ...
  setTimeout(() => {
    ...
    MongoClient.connect(uri, (err, client) => {
      ...
      db.collection("womenT").deleteMany();
      console.log(
        "--------------------DATA REFRESHED---------------\n.\n.\n.\n."
      );
      db.collection("womenT").insertMany(Final, (err, result) => {
