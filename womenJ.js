...
const url =
  "https://www.flipkart.com/clothing-and-accessories/winter-wear/jackets/womens-jackets/pr?sid=clo%2Cqvw%2Cz0g%2Crwo&q=jackets+sports&otracker=categorytree&p%5B%5D=facets.brand%255B%255D%3DADIDAS&p%5B%5D=facets.brand%255B%255D%3DREEBOK&p%5B%5D=facets.brand%255B%255D%3DNike&p%5B%5D=facets.brand%255B%255D%3DUNDER%2BARMOUR&p%5B%5D=facets.brand%255B%255D%3DPuma";
...
let getData = (html) => {
  ...
  $("._2B_pmu").each((index, element) => {
    ...
    TBrand[index] = { iD, Category: "Jacket", Brand, Gender: "F" };
  });
  ...
  setTimeout(() => {
    ...
    MongoClient.connect(uri, (err, client) => {
      ...
      db.collection("womenJ").deleteMany();
      console.log(
        "--------------------DATA REFRESHED---------------\n.\n.\n.\n."
      );
      db.collection("womenJ").insertMany(Final, (err, result) => {
