...
const url =
  "https://www.flipkart.com/clothing-and-accessories/winter-wear/jackets/mens-jackets/pr?sid=clo%2Cqvw%2Cz0g%2Cjbm&q=jackets+sports&otracker=categorytree&p%5B%5D=facets.brand%255B%255D%3DADIDAS&p%5B%5D=facets.brand%255B%255D%3DPuma&p%5B%5D=facets.brand%255B%255D%3DNike&p%5B%5D=facets.brand%255B%255D%3DREEBOK";
...
let getData = (html) => {
  ...
  $("._2B_pmu").each((index, element) => {
    ...
    TBrand[index] = { iD, Category: "Jacket", Brand, Gender: G };
  });
